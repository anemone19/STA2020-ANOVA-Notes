...
```{r qq, fig.height=3, label= fig-socialqq, fig.cap="Q-Q plots of response per treatment group."}
...
```{r,  label= fig-socialdotchart, fig.cap="Cleveland dot chart of response values in the order in which they appear in the data set."}
