...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, left=2mm, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, titlerule=0mm, breakable, opacitybacktitle=0.6, colback=white, coltitle=black, opacityback=0, bottomtitle=1mm, title={Example 5.1}, rightrule=.15mm, arc=.35mm, leftrule=.75mm]
...
enables the partitioning of the total sum of squares\sidenote{\footnotesize In
  statistics, sums of squares is a measure of variability and refers to
  squared deviations from a mean or expected value. For example, the
  residual sums of squares (sum of squared deviations of the
  observations from the fitted values).} into independent parts, one for
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4316}}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0842}}@{}}
\toprule\noalign{}
