...
Often, an ANOVA is expected in journal publications and research reports, even if it does not answer the specific research questions. However, an ANOVA is almost never enough. The more specific questions are answered by constructing confidence intervals or tests for contrasts.
...
With these question, conducting an ANOVA is enough. We simply want to know if there are any main effects or interaction effect. We have answered that with the ANOVA above. But what if the questions were a bit more specific: 
